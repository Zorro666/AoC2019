...
namespace Day05
{
    class Program
    {
        private Program(string inputFile, int input)
        {
            var source = ReadProgram(inputFile);
            var result = RunProgram(source, input);
            Console.WriteLine($"Day05 : Result {result}");
        }
        ...
        static public string RunProgram(string source, int input)
        {
        ...
        public static void Run()
        {
            ...
            _ = new Program("Day05/input.txt", 1);
            _ = new Program("Day05/input.txt", 5);
