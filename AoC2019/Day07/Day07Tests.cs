...
namespace Day07
{
    ...
    public class Tests
    {
        ...
        public void RunProgramsPart1(string source, int phase0, int phase1, int phase2, int phase3, int phase4, int expected)
        {
            Assert.That(Program.RunPrograms(source, phase0, phase1, phase2, phase3, phase4, false), Is.EqualTo(expected));
        }
        ...
        public void RunProgramsPart2(string source, int phase0, int phase1, int phase2, int phase3, int phase4, int expected)
        {
            Assert.That(Program.RunPrograms(source, phase0, phase1, phase2, phase3, phase4, true), Is.EqualTo(expected));
        }
    }
}
